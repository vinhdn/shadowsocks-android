 ...
 *    &lt;application&gt;
 *        ...
 *        &lt;provider android:name="com.nowtoapps.bluevpn.$PLUGIN_ID.BinaryProvider"
 *                     android:authorities="com.nowtoapps.bluevpn.plugin.$PLUGIN_ID.BinaryProvider"&gt;
 *            &lt;intent-filter&gt;
 *                &lt;category android:name="com.nowtoapps.bluevpn.plugin.ACTION_NATIVE_PLUGIN" /&gt;
 *            &lt;/intent-filter&gt;
 *        &lt;/provider&gt;
 *        ...
 *    &lt;/application&gt;
